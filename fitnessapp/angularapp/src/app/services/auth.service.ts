...
export class AuthService {
  ...
  public apiUrl = apiUrl; // Replace with your Node.js backend URL
  ...
  register(user: User): Observable<any> {
    ...
    return this.http.post<any>(`${this.apiUrl}/user/signup`, body).pipe(
      ...
      .pipe(
        tap(response => {
          ...
          if (decodedToken) {
            ...
            this.userIdSubject.next(decodedToken['_id']);
