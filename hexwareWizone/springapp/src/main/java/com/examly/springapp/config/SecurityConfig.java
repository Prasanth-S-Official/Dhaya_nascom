...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .requestMatchers(HttpMethod.DELETE, "/api/wifiSchemeRequest/{wifiSchemeRequestId}").hasRole("User")
                .requestMatchers(HttpMethod.GET, "/api/wifiSchemeRequest").hasRole("Admin")
                .requestMatchers(HttpMethod.GET, "/api/wifiSchemeRequest/user/{userId}").hasRole("User")
                .requestMatchers(HttpMethod.GET, "/api/wifiSchemeRequest/{wifiSchemeRequestId}").hasRole("Admin")
