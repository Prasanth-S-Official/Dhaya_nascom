...
export function FormLayout({
  ...
  const handleLogout = () => {
    ...
    navigate("/"); // ✅ Change this if you want to redirect to "/login" or another path
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <button
        ...
        className="absolute top-4 right-4 text-gray-600 hover:text-red-600 flex items-center gap-1"
        title="Logout"
      >
        <LogOut size={18} />
