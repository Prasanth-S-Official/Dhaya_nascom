...
export default function ForgotPassword() {
  const serviceRoleKey =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdtbmZlb2FzZWllcGpsd3hmeHd6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDM3ODcyODIsImV4cCI6MjA1OTM2MzI4Mn0.8fLJtZi1siljidzfvXw4wrErtP8_QmxbZoaW9EuKX50';
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        "https://gmnfeoaseiepjlwxfxwz.supabase.co/functions/v1/send-otp",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${serviceRoleKey}`,
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        "https://gmnfeoaseiepjlwxfxwz.supabase.co/functions/v1/update-password",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${serviceRoleKey}`,
