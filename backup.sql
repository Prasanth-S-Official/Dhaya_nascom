...
CREATE TABLE `driver` (
  ...
  CONSTRAINT `FKkux9gqt7e9mh4rd4oo4i5ov0f` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
...
INSERT INTO `user` VALUES (1,'manager@gmail.com','1234567890','$2a$10$GWh2K/NI6Z69VORP9DUrtO0ybTbPZvls0vWLqBtWa2XbfA7ZjhjJ2','Manager','Manager');
...
-- Dump completed on 2024-12-31 10:43:18
