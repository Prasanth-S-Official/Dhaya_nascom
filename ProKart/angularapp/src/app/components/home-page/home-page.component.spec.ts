...
describe('HomePageComponent', () => {
  ...
  fit('Frontend_should_display_title_prokart_in_home_page_component', () => {
    const compiled = fixture.nativeElement;
    expect(compiled.textContent).toContain('ProKart');
  });

  fit('Frontend_should_display_content_paragraph_in_home_page_component', () => {
    const compiled = fixture.nativeElement;
    expect(compiled.textContent).toContain('your one-stop solution for seamless online shopping');
  });
